...
const stateCache = {};
const initializePlugin = ({ reporter }, pluginOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const api = yield (0, remoteGraphQLSchema_1.getRemoteGraphQLSchema)(client, config);
        reporter.info('[sanity] Transforming to Gatsby-compatible GraphQL SDL');
        const graphqlSdl = yield (0, rewriteGraphQLSchema_1.rewriteGraphQLSchema)(api, { config, reporter });
...
const onPreInit = ({ reporter }) => __awaiter(void 0, void 0, void 0, function* () {
...
const onPreBootstrap = (args, pluginOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!coreSupportsOnPluginInit) {
        yield initializePlugin(args, pluginOptions);
    }
});
exports.onPreBootstrap = onPreBootstrap;
const onPluginInit = (args, pluginOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDocumentIds = (client) => __awaiter(void 0, void 0, void 0, function* () {
    // Largish batch size to reduce network round trips without putting too much stress on API
    const batchSize = 30000;
    let prevId;
    let ids = [];
    while (true) {
        const batch = yield client.fetch(prevId !== undefined
...
const sourceNodes = (args, pluginConfig) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (lastBuildTime) {
        try {
            ...
            const documentIds = new Set(yield getDocumentIds(client));
            ...
            deltaHandled = yield (0, handleDeltaChanges_1.default)({
                args,
                lastBuildTime,
                client,
                syncWithGatsby,
    ...
    if (!deltaHandled) {
        ...
        documents = yield (0, downloadDocuments_1.default)(url, config.token, { includeDrafts: overlayDrafts });
...
const setFieldsOnGraphQLNodeType = (context, pluginConfig) => __awaiter(void 0, void 0, void 0, function* () {
    const { type } = context;
    let fields = {};
...
const onCreateDevServer = ({ app }) => __awaiter(void 0, void 0, void 0, function* () {
